...
export default function About(){
  ...
  return (
    <section id="about" className="section">
      <Container>
        {/* Kicker superior */}
        <p className="text-xs tracking-widest uppercase opacity-70 mb-3">{t('about.kicker', lang)}</p>
        <SectionTitle
          title={t('about.title', lang)}
          subtitle={t('about.lead1', lang)}
        />
        ...
        <div className="grid gap-8 md:gap-10 lg:gap-12 md:grid-cols-12 items-start">
          ...
          <figure className="md:col-span-5 lg:col-span-5">
            ...
            <ul className="mt-4 flex flex-wrap gap-2">
              {[
                ...
                <li key={b} className="inline-flex items-center rounded-full border border-neutral-200 dark:border-neutral-800 px-3 py-1 text-xs font-medium" data-aos="fade-up">
                  {b}
                </li>
              ))}
            </ul>
          ...
          <div className="md:col-span-7 lg:col-span-7">
            <p className="text-base leading-relaxed text-[#372549] mb-4">{t('about.lead2', lang)}</p>

            <div className="grid gap-4 sm:grid-cols-2">
              {/* Highlight cards: sólo AOS en elementos, no en el section */}
            ...
            {/* Viajes: mini galería lateral para reforzar lo global */}
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-neutral-100 dark:bg-neutral-900" data-aos="fade-up">
                <img src="/images/grecia/orange.webp" alt="Travel inspiration" className="h-full w-full object-cover" loading="lazy"/>
              </div>
              <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-neutral-100 dark:bg-neutral-900" data-aos="fade-up" data-aos-delay="80">
                <img src="/images/grecia/choco.webp" alt="Markets & product" className="h-full w-full object-cover" loading="lazy"/>
              </div>
            </div>
          </div>
        </div>
